...
const dateFormat = (_date: string, separator: string) => {
  ...
  return `${day}${separator}${month}${separator}${year}`; // Concatenate the day, month, and year strings with the period separator
};
